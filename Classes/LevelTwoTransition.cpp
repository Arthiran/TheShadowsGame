...
Scene* LevelTwoTransition::createScene()
{
	//Background Music
	...
	LevelTwoTransition* layer = LevelTwoTransition::create();
...
void LevelTwoTransition::onExit()
{
	Scene::onExit();
}

void LevelTwoTransition::onEnter()
{
...
//Call constantly
void LevelTwoTransition::update(float deltaTime)//UPDATE LOOP
{
...
void LevelTwoTransition::SceneChange()
{
...
void LevelTwoTransition::DrawWorld()
{
...
Scene* LevelTwoTransition::sceneHandle = nullptr;