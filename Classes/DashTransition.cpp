...
Scene* DashTransition::createScene()
{
	//Background Music
	...
	DashTransition* layer = DashTransition::create();
...
void DashTransition::onExit()
{
	Scene::onExit();
}

void DashTransition::onEnter()
{
...
//Call constantly
void DashTransition::update(float deltaTime)//UPDATE LOOP
{
...
void DashTransition::SceneChange()
{
	Scene* scene = DashLevel::createScene();
	director->getInstance()->replaceScene(scene);

	//director->runWithScene(scene);
}

void DashTransition::DrawWorld()
{
...
Scene* DashTransition::sceneHandle = nullptr;