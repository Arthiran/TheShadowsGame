...
Scene* LevelFourTrans::createScene()
{
	//Background Music
	...
	LevelFourTrans* layer = LevelFourTrans::create();
...
void LevelFourTrans::onExit()
{
	Scene::onExit();
}

void LevelFourTrans::onEnter()
{
...
//Call constantly
void LevelFourTrans::update(float deltaTime)//UPDATE LOOP
{
...
void LevelFourTrans::SceneChange()
{
...
Scene* LevelFourTrans::sceneHandle = nullptr;