...
Scene* BossTransition::createScene()
{
	//Background Music
	...
	BossTransition* layer = BossTransition::create();
...
void BossTransition::onExit()
{
	Scene::onExit();
}

void BossTransition::onEnter()
{
...
//Call constantly
void BossTransition::update(float deltaTime)//UPDATE LOOP
{
...
void BossTransition::SceneChange()
{
	Scene* scene = BossLevel::createScene();
	director->getInstance()->replaceScene(scene);

	//director->runWithScene(scene);
}

void BossTransition::DrawWorld()
{
...
Scene* BossTransition::sceneHandle = nullptr;